...
- **Licensor**: Zechariah Zimmerman
- **Licensed Work**: Build Secure Transport
- **Change Date**: Four years from each release date
- **Change License**: MIT License
- **Additional Use Grant**: You may use the Licensed Work for non-production purposes including security auditing, research, testing, and contributing improvements back to this project.
